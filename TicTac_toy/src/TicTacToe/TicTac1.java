 ...
 * @author Raj
 */
public class TicTac1 extends javax.swing.JFrame {
    ...
    {
        jlplayerX.setText(String.valueOf(xCount));
        jlplayero.setText(String.valueOf(oCount));
    }
    ...
    private void initComponents() {
        ...
        jlplayerX.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlplayerX.setText("jLabel3");
        ...
        jlplayero.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jlplayero.setText("jLabel5");
        ...
        jPanel12.add(jbtnReset, java.awt.BorderLayout.CENTER);
        ...
        jPanel9.add(jbtnExit, java.awt.BorderLayout.CENTER);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTac1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
